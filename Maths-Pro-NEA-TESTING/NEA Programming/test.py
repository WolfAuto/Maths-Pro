...
label_4 = Label(root, text="Student or Teacher", width=20, font=("bold", 10))
label_4.place(x=80, y=330)
var1 = IntVar()
Checkbutton(root, text="student", variable=var1).place(x=220, y=330)
var2 = IntVar()
Checkbutton(root, text="teacher", variable=var2).place(x=290, y=330)
