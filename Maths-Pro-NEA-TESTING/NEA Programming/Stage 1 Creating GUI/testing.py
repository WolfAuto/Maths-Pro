...
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg, NavigationToolbar2Tk  # nopep8
from matplotlib.figure import Figure  # nopep8
...
class PageThree(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        label = tk.Label(self, text="Page Three Graph Page", font=("Times New Roman", 20))
        label.pack(pady=10, padx=10)
